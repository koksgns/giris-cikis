...
<body>
    <?php if (isset($_SESSION["id"])) : ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #e3f2fd;">
            <div class="container d-flex justify-content-between">
                ...
                <a class="nav-link " href="index.php?s=profile"><b><?= $_SESSION["user_name"] ?></b></a>
        ...
        <?php if(isset($_GET["s"])): ?>
            <section class="row mt-5">
                <div class="col-md-6 m-auto text-center">
                    ...
                    <h4 class="title-style text-center mt-3 mb-4">Parola Değiştir</h4>
    ...
    <?php else : ?>
        <section class="row mt-5">
            <div class="col-md-6 m-auto text-center">
                ...
                <form action="" class="w-75 m-auto" id="giris_frm" onsubmit="return false">
                    <div class="input-group mb-3">
    ...
    <script>
        $("#giris_frm").on("submit", function(event) {
